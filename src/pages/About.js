        ...
        <div className="about container">
            <section>
              ...
              <p>
                ...
                discovered my passion-projects are web accessibility and motivating
                people of <em>all</em> backgrounds looking to break into tech.
              </p>
            </section>
                ...
                {timeline.map((milestone, index) => {
                  return (
                    <li key={index}>
                      ...
                      <span dangerouslySetInnerHTML={{ __html: milestone.text }} />
                    </li>
                  );
                })}
              </ul>
